  ...
  return (
    <div className="container">
      <div className="title">
        ...
        <p>To use Bluetooth and Microphone, enable chrome experimental mode by typing
          <i style={{color: "blue"}}> "chrome://flags/#enable-experimental-web-platform-features" </i>
          in Chrome browser
        </p>
      </div>
